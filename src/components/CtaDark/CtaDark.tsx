...
export function CtaDark() {
  return (
    <div className="px-6 my-20 md:my-64">
      <div className="max-w-5xl px-4 py-6 mx-auto border-transparent bg-radialBlack md:px-16 md:py-12 rounded-3xl shadow-dark">
